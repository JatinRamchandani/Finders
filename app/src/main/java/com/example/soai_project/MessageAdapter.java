...
public class MessageAdapter extends RecyclerView.Adapter {
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        ...
        public ReceivedMessageHolder(@NonNull View itemView) {
            super(itemView);
             ...
             ImageText = itemView.findViewById(R.id.senderimageper);
    ...
    private class ReceivedImageHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imageView;
         ImageView  senderperson;

        public ReceivedImageHolder(@NonNull View itemView) {
            super(itemView);

            imageView = itemView.findViewById(R.id.imageView);
            senderperson = itemView.findViewById(R.id.senderimagepere);
        ...
        try {
            if (message.getBoolean("isSent")) {
                ...
                if (message.has("message")) {
                    ...
                    messageHolder.ImageText.setImageResource(R.drawable.person);
                    messageHolder.messageTxt.setText(message.getString("message"));

                } else {

                    ReceivedImageHolder imageHolder = (ReceivedImageHolder) holder;
                    imageHolder.senderperson.setImageResource(R.drawable.person);
