...
public class InboxMenuActivity extends AppCompatActivity {
    //define the Switches
    ...
    private  static  final String ex="Switch10";
    private  static  final String ex2="Switch11";
    private  static  final String ex3="Switch12";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aSwitch=(Switch)findViewById(R.id.switchin1);
        aSwitch2=(Switch)findViewById(R.id.switchin2);
        aSwitch3=(Switch)findViewById(R.id.switchin3);
